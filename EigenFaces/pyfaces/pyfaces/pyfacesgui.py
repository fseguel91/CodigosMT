...
class PyFaceUI(object):
    ...
    def makeLabels(self):
        ...
        self.imgSelLabel=Label(self.imgSelectFrame,text="Elegir Imagen  Prueba")
        self.imgSelLabel.pack(side=LEFT)        
        #self.dirSelLabel=Label(self.dirSelectFrame,text="Select folder of images")
        self.dirSelLabel=Label(self.dirSelectFrame,text="Elegir Base  de   Datos")
    ...
    def makeButtons(self):
        ...
        self.qtButton.configure(width=button_width,text="Salir",command=self.quitButtonClick,padx=button_padx,pady=button_pady,anchor=E)    
